...
public class ShipDAOImpl implements ShipDAO
{
	...
	public  List<ShipModel> getAll() {
		Session s=sessionFactory.openSession();
		s.beginTransaction();
		Query query =s.createQuery("from ShipModel"); //where cusid=:cusid").setParameter("cusid", cusid);       
		//List<ShipModel> results =s.createQuery("from ShipModel where cusid=:cusid)..setParameter("cusid", cusid); 
